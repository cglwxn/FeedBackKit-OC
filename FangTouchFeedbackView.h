...
/// 手指离开view时的事件回调,通常只需在这一个回调中处理点击事件即可. 默认是本view对点击作出反馈.参数:view 当subViewTouchFeedback设置为YES时,view表示具体的接收点击的子view.当subViewTouchFeedback设置为NO时,view表示本view.touchPoint:触摸位置,相对于window的坐标系统中.
